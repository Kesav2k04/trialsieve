...
### 3. llm_request -> gemini-3.7-flash-medium  cassette `a7f01046d7f12504`
...
### 4. llm_response (openai, 104 tok, 65.20736598968506s)

```
```json
{
  "checkable": true,
  "reason": "Checkable by querying coded diagnosis records for diabetic ketoacidosis occurring within 1 month prior to the index date, anchoring the screening visit to the index date.",
  "concepts": [
    {
      "name": "Diabetic ketoacidosis",
      "domain": "condition",
      "intent": "diagnosis or acute event of diabetic ketoacidosis within the past 1 month"
    }
  ]
}
```
...
### 7. llm_request -> gemini-3.7-flash-medium  cassette `1158374b4cd040b1`
...
### 8. llm_response (openai, 121 tok, 58.0392107963562s)
...
```json
{
  ...
  "note": "Includes general DKA, type-specific diabetic ketoacidosis, coma variants, and euglycemic presentation."
}
```
```
...
[
 ...
 },
 {
  ...
  "display": "Chronic intra
```

### 11. llm_request -> gemini-3.7-flash-medium  cassette `87265e14717020d2`
...
Concept: Diabetic ketoacidosis
Record domain: condition
Meaning required: diagnosis or acute event of diabetic ketoacidosis within the past 1 month
...
### 12. llm_response (openai, 367 tok, 184.445951461792s)
...
```json
{
  ...
  "rejected": [
    {
      "code": "368581000119106",
      "why": "diabetic neuropathy, not diabetic ketoacidosis"
    },
    {
      "code": "90781000119102",
      "why": "diabetic microalbuminuria/renal involvement, not diabetic ketoacidosis"
    },
    {
      "code": "1551000119108",
    ...
    {
      "code": "97331000119101",
      "why": "macular edema and retinopathy due to diabetes, not diabetic ketoacidosis"
    },
    {
      "code": "422034002",
      "why": "diabetic retinopathy, not diabetic ketoacidosis"
    },
    {
      "code": "1501000119109",
      "why": "proliferative diabetic retinopathy, not diabetic ketoacidosis"
    },
    {
      "code": "127013003",
    ...
    {
      "code": "44054006",
      "why": "diabetes mellitus unspecified/underlying condition, not diabetic ketoacidosis"
    },
    {
      "code": "94260004",
...
```json
{
 ...
 "rejected": [
  ...
  {
   "code": "431855005",
   "why": "chronic kidney disease stage 1, unrela
```
