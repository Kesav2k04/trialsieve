...
### 3. llm_request -> gemini-3.7-flash-medium  cassette `fe7ccc3f94d41094`
...
### 4. llm_response (openai, 103 tok, 27.587830781936646s)

```
```json
{
  "checkable": false,
  "reason": "The criterion requires assessing future pregnancy intention, which cannot be determined from structured medical records.",
  "concepts": [
    {
      "name": "pregnancy",
      "domain": "condition",
      "intent": "current pregnancy"
    },
    {
      "name": "breastfeeding",
      "domain": "condition",
      "intent": "current breastfeeding"
    }
  ]
}
```
...
{
 "compilable": false,
 "reason_not_compilable": "The criterion requires assessing future pregnancy intention, which cannot be determined from structured medical records."
}
```
