...
{
 "category": "medication",
 "criterion_id": "NCT06717698-INC-06",
 "kind": "inclusion",
 "source_text": "Treatment with maximum labelled or tolerated dose of an ACE inhibitor or an ARB, unless contraindicated or not tolerated in the opinion of the investigator. Treatment dose must be stable for at least 30 days prior to screening."
}
```

### 3. llm_request -> gemini-3.7-flash-medium  cassette `c5d9d93a8bec5f22`
...
### 4. llm_response (openai, 124 tok, 17.444626331329346s)

```
```json
{
  "checkable": false,
  "reason": "The criterion relies on the investigator's opinion regarding drug tolerability and contraindications, as well as subjective determination of maximum tolerated dose.",
  "concepts": [
    {
      "name": "ACE inhibitor",
      "domain": "medication",
      "intent": "prescribed drug of this class"
    },
    {
      "name": "Angiotensin receptor blocker",
      "domain": "medication",
      "intent": "prescribed drug of this class"
    }
  ]
...
{
 "compilable": false,
 "reason_not_compilable": "The criterion relies on the investigator's opinion regarding drug tolerability and contraindications, as well as subjective determination of maximum tolerated dose."
}
```
