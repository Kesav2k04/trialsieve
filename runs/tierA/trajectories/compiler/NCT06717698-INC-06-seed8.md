...
### 3. llm_request -> gemini-3.7-flash-medium  cassette `5fe7ee84e676f554`
...
### 4. llm_response (openai, 132 tok, 31.401126861572266s)

```
```json
{
  "checkable": false,
  "reason": "The criterion requires the investigator's opinion and clinical judgment to determine contraindication or maximum tolerated dose.",
  "concepts": [
    {
      "name": "ACE inhibitor",
      "domain": "medication",
      "intent": "prescribed dose stable for at least 30 days prior to index date"
    },
    {
...
{
 "compilable": false,
 "reason_not_compilable": "The criterion requires the investigator's opinion and clinical judgment to determine contraindication or maximum tolerated dose."
}
```
