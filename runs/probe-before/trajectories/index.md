...
1. **[the grounder could not map the concept, and stopped rather than guessing](vocab_probe/absent-Chronic_kidney_disease_stage_3_or_worse.md)** (vocab_probe, `absent-Chronic_kidney_disease_stage_3_or_worse`). 8 of these. A near miss on a drug class is indistinguishable from a hit right up until it clears a patient, so an unmappable concept ends the step instead of returning the closest code.
...
|---|---|---|---|---|---|---|---|
| vocab_probe | [absent-Chronic_kidney_disease_stage_3_or_worse](vocab_probe/absent-Chronic_kidney_disease_stage_3_or_worse.md) | 2 | 0 | 0 | 0 | 0 | unmappable |
...
| vocab_probe | [gap-Type_2_diabetes_mellitus](vocab_probe/gap-Type_2_diabetes_mellitus.md) | 2 | 0 | 0 | 0 | 0 | unmappable |
