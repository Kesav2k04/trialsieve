...
| arm | coverage | SER   | **resolved correct / screen** | silent | false-FAILS | false-MEETS | unnecessary abstention | errors | unique criteria |
|-----|----------|-------|-------------------------------|--------|-------------|-------------|------------------------|--------|-----------------|
| TS  | 21.8%    | 1.0%  | **2.77**                      | 4      | 4           | 0           | 18                     | 0      | 40              |
| B0  | 100.0%   | 93.8% | **0.83**                      | 375    | 375         | 0           | 0                      | 0      | 40              |
| B1  | 7.5%     | 0.0%  | **1.00**                      | 0      | 0           | 0           | 75                     | 0      | 40              |
| B2  | 68.0%    | 43.8% | **3.23**                      | 175    | 30          | 145         | 6                      | 0      | 40              |

**The co-primary goes to B2.** `docs/EVAL_PROTOCOL.md` registers `resolved_correct_per_screen` as a co-primary outcome, in its own words *so an arm cannot win by abstaining*, and on this group B2 resolves 3.23 cells correctly per screen against TrialSieve's 2.77. Abstaining costs nothing on silent error rate and it costs exactly this. Both numbers are in the table above rather than in a footnote, because the outcome was registered before the run and the arm it favours does not change that.
...
| arm | coverage | SER   | **resolved correct / screen** | silent | false-FAILS | false-MEETS | unnecessary abstention | errors | unique criteria |
|-----|----------|-------|-------------------------------|--------|-------------|-------------|------------------------|--------|-----------------|
| TS  | 19.1%    | 0.7%  | **2.46**                      | 111    | 66          | 45          | 618                    | 0      | 40              |
| B0  | 100.0%   | 94.8% | **0.70**                      | 14594  | 14594       | 0           | 0                      | 0      | 40              |
| B1  | 7.5%     | 0.0%  | **1.00**                      | 0      | 0           | 0           | 2401                   | 0      | 40              |

**The co-primary goes to TS**, 2.46 cells resolved correctly per screen against 1.00 for the next arm. It is registered in `docs/EVAL_PROTOCOL.md` so that an arm cannot win by abstaining, so it is printed whichever way it falls.
...
| arm | coverage | SER   | **resolved correct / screen** | silent | false-FAILS | false-MEETS | unnecessary abstention | errors | unique criteria |
|-----|----------|-------|-------------------------------|--------|-------------|-------------|------------------------|--------|-----------------|
| TS  | 19.2%    | 0.7%  | **2.47**                      | 112    | 67          | 45          | 605                    | 0      | 40              |
| B0  | 100.0%   | 94.8% | **0.70**                      | 14594  | 14594       | 0           | 0                      | 0      | 40              |
| B1  | 7.5%     | 0.0%  | **1.00**                      | 0      | 0           | 0           | 2401                   | 0      | 40              |

**The co-primary goes to TS**, 2.47 cells resolved correctly per screen against 1.00 for the next arm. It is registered in `docs/EVAL_PROTOCOL.md` so that an arm cannot win by abstaining, so it is printed whichever way it falls.
...
| arm | coverage | SER   | **resolved correct / screen** | silent | false-FAILS | false-MEETS | unnecessary abstention | errors | unique criteria |
|-----|----------|-------|-------------------------------|--------|-------------|-------------|------------------------|--------|-----------------|
| TS  | 21.6%    | 0.7%  | **2.79**                      | 112    | 67          | 45          | 235                    | 0      | 40              |
| B0  | 100.0%   | 94.8% | **0.70**                      | 14594  | 14594       | 0           | 0                      | 0      | 40              |
| B1  | 7.5%     | 0.0%  | **1.00**                      | 0      | 0           | 0           | 2401                   | 0      | 40              |

**The co-primary goes to TS**, 2.79 cells resolved correctly per screen against 1.00 for the next arm. It is registered in `docs/EVAL_PROTOCOL.md` so that an arm cannot win by abstaining, so it is printed whichever way it falls.
...
| arm | coverage | SER   | **resolved correct / screen** | silent | false-FAILS | false-MEETS | unnecessary abstention | errors | unique criteria |
|-----|----------|-------|-------------------------------|--------|-------------|-------------|------------------------|--------|-----------------|
| TS  | 18.8%    | 0.8%  | **2.41**                      | 116    | 65          | 51          | 635                    | 0      | 40              |
| B0  | 100.0%   | 95.0% | **0.67**                      | 14623  | 14623       | 0           | 0                      | 0      | 40              |
| B1  | 7.5%     | 0.0%  | **1.00**                      | 0      | 0           | 0           | 2357                   | 0      | 40              |

**The co-primary goes to TS**, 2.41 cells resolved correctly per screen against 1.00 for the next arm. It is registered in `docs/EVAL_PROTOCOL.md` so that an arm cannot win by abstaining, so it is printed whichever way it falls.
...
| arm | coverage | SER   | **resolved correct / screen** | silent | false-FAILS | false-MEETS | unnecessary abstention | errors | unique criteria |
|-----|----------|-------|-------------------------------|--------|-------------|-------------|------------------------|--------|-----------------|
| TS  | 18.5%    | 0.7%  | **2.37**                      | 105    | 60          | 45          | 662                    | 0      | 40              |
| B0  | 100.0%   | 95.0% | **0.67**                      | 14625  | 14625       | 0           | 0                      | 0      | 40              |
| B1  | 7.5%     | 0.0%  | **1.00**                      | 0      | 0           | 0           | 2320                   | 0      | 40              |

**The co-primary goes to TS**, 2.37 cells resolved correctly per screen against 1.00 for the next arm. It is registered in `docs/EVAL_PROTOCOL.md` so that an arm cannot win by abstaining, so it is printed whichever way it falls.
...
| arm | coverage | SER   | **resolved correct / screen** | silent | false-FAILS | false-MEETS | unnecessary abstention | errors | unique criteria |
|-----|----------|-------|-------------------------------|--------|-------------|-------------|------------------------|--------|-----------------|
| TS  | 17.5%    | 0.9%  | **2.21**                      | 135    | 81          | 54          | 706                    | 0      | 40              |
| B0  | 100.0%   | 95.3% | **0.63**                      | 14677  | 14677       | 0           | 0                      | 0      | 40              |
| B1  | 7.5%     | 0.0%  | **1.00**                      | 0      | 0           | 0           | 2183                   | 0      | 40              |

**The co-primary goes to TS**, 2.21 cells resolved correctly per screen against 1.00 for the next arm. It is registered in `docs/EVAL_PROTOCOL.md` so that an arm cannot win by abstaining, so it is printed whichever way it falls.
...
| arm | coverage | SER  | **resolved correct / screen** | silent | false-FAILS | false-MEETS | unnecessary abstention | errors | unique criteria |
|-----|----------|------|-------------------------------|--------|-------------|-------------|------------------------|--------|-----------------|
| TS  | 18.4%    | 0.7% | **2.36**                      | 111    | 66          | 45          | 727                    | 0      | 40              |
...
`docs/EVAL_PROTOCOL.md` section 10 registers these before the first scored run. A prediction that is only checked when it holds is not a prediction, so all five are here, including the one that cannot be checked with what ran.

| # | registered                                                                                                                                      | measured                                                                                                      | held                          |
|---|-------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------|-------------------------------|
| 1 | coverage lands at 30 to 40% of segmented criteria                                                                                               | 29.2% (19 of 65)                                                                                              | **no, below the band**        |
| 2 | B2 is close to TS on plain numeric criteria and separates on unit traps, temporal windows and degraded records                                  | not testable as registered: B2 ran at k = 0 only, so the degraded-record half has no data in either direction | **partly untested**           |
| 3 | B2's headline weakness is overcommitment rather than accuracy: it answers where gold is INDETERMINATE rather than getting committed cells wrong | 173 of B2's 175 silent errors are commitments where gold is INDETERMINATE, and 2 contradict a definite answer | **yes**                       |
| 4 | the gap at k = 0 is small, and a large one is suspicious and is investigated before it is reported                                              | 42.75 points, which is large. The investigation is the section above                                          | **no, and the trigger fired** |
| 5 | TS panel reduction is lower than B2's apparent reduction, and B2's voids on false exclusions                                                    | TS 53.3% against B2 86.7%, and B2 is VOID on 10 false exclusions                                              | **yes**                       |

**2 of 5 held as registered.** The coverage band was missed low, the k = 0 prediction was wrong in its premise and is investigated above, and one is partly untestable because the per-cell arm was never run against a degraded record. None of that is a defect in the result; leaving it unreported would have been a defect in the reporting.
