...
### 3. llm_request -> gemini-3.7-flash-medium  cassette `fc48e08877e8442c`
...
### 4. llm_response (cassette, 227 tok, 45.465s)

```
```json
{
  "checkable": true,
  "reason": "Medication exposure within the past 3 months can be verified from coded prescription and dispensing records anchored to the index date.",
  "concepts": [
    {
      "name": "GLP-1 receptor agonist",
      "domain": "medication",
      "intent": "prescription or use within the past 3 months"
    },
    {
...
### 11. llm_request -> gemini-3.7-flash-medium  cassette `c85e72971ef2bdcb`
...
### 12. llm_response (cassette, 80 tok, 180.284s)
...
```json
{
  ...
  "note": "Includes generic ingredient, salt form, brand names, and combination formulations containing rosiglitazone."
}
```
```
...
### 15. llm_request -> gemini-3.7-flash-medium  cassette `ef5736c57d33fd9e`
...
Concept: Rosiglitazone
Record domain: medication
Meaning required: prescription or use within the past 3 months
...
### 16. llm_response (cassette, 90 tok, 56.928s)
...
```json
{
  ...
  "rejected": [
    {
      "code": "477045",
      "why": "Chlorpheniramine maleate is an antihistamine, not rosiglitazone"
    },
    {
      "code": "860975",
      "why": "Metformin hydrochloride is a different active ingredient/antidiabetic agent, not rosiglitazone"
    }
  ],
  "confidence": "high"
}
...
### 20. llm_request -> gemini-3.7-flash-medium  cassette `8bdeacdbc970ec68`
...
### 21. llm_response (openai, 123 tok, 19.40356135368347s)
...
```
{
  ...
  "note": "Includes standard generic forms, stereoisomers (d- and dl-), ester formulations (acetate and succinate), and water-soluble derivatives."
}
```
...
### 24. llm_request -> gemini-3.7-flash-medium  cassette `d328d6fb0e82db55`
...
### 25. llm_response (openai, 181 tok, 20.258041858673096s)
...
```json
{
  ...
  "rejected": [
    {
      "code": "2001499",
      "why": "Vitamin B12 is a completely different vitamin than Vitamin E (tocopherol)"
    },
    {
      "code": "1000126",
      "why": "Medroxyprogesterone acetate is a progestin hormone medication, not Vitamin E"
    },
    {
      "code": "752899",
      "why": "Leuprolide acetate is a GnRH analog, not Vitamin E"
    },
    {
      "code": "904419",
      "why": "Alendronic acid is a bisphosphonate, not Vitamin E"
    },
    {
      "code": "1043400",
      "why": "Acetaminophen / dextromethorphan / doxylamine is a multi-ingredient cold and cough formulation, not Vitamin E"
    }
  ],
  "confidence": "high"
}
...
### 29. llm_request -> gemini-3.7-flash-medium  cassette `986ab3f5808173a9`
...
### 30. llm_response (openai, 84 tok, 43.07283020019531s)
...
```json
{
  ...
  "note": "Includes generic names (ursodeoxycholic acid, ursodiol) and common brand names across clinical formulations."
}
```
```
...
### 33. llm_request -> gemini-3.7-flash-medium  cassette `29c9f7fb3cf6e371`
...
### 34. llm_response (openai, 212 tok, 44.77377963066101s)
...
```json
{
  ...
  "rejected": [
    {
      "code": "309097",
      "why": "different active ingredient (cefuroxime, a cephalosporin antibiotic)"
    },
    {
      "code": "904419",
      "why": "different active ingredient (alendronic acid, a bisphosphonate for bone disorders)"
    },
    {
      "code": "308182",
      "why": "different active ingredient (amoxicillin, a penicillin antibiotic)"
    },
    {
      "code": "309045",
      "why": "different active ingredient (cefaclor, a cephalosporin antibiotic)"
    },
    {
      "code": "562251",
      "why": "different active ingredients (amoxicillin and clavulanate, antibacterial combination)"
    },
    {
      "code": "834061",
      "why": "different active ingredient (penicillin V potassium, an antibiotic)"
    }
  ],
  "confidence": "high"
}
