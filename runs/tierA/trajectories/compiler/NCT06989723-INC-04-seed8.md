...
### 3. llm_request -> gemini-3.7-flash-medium  cassette `97ade9bb71a0a8d7`
...
### 4. llm_response (cassette, 123 tok, 41.619s)

```
```json
{
  "checkable": false,
  "reason": "Requires FibroScan elastography and controlled attenuation parameter (CAP) readout values, which are measurements structured medical records do not normally hold.",
  "concepts": [
    {
      "name": "hepatic steatosis",
      "domain": "condition",
      "intent": "diagnosis or evidence of hepatic steatosis"
    },
    {
      "name": "FibroScan",
      "domain": "procedure",
      "intent": "transient elastography procedure"
    }
  ]
}
```
...
{
 "compilable": false,
 "reason_not_compilable": "Requires FibroScan elastography and controlled attenuation parameter (CAP) readout values, which are measurements structured medical records do not normally hold."
}
```
