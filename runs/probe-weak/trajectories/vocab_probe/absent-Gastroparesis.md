...
### 3. llm_request -> granite3.1-dense:8b  cassette `10bc6e8ca55981e5`
...
### 4. llm_response (openai, 214 tok, 3.929s)
...
```
{
  "names": [
    ...
    "Gastric Retention",
    "Qualitative Abnormality of Gastric Emptying",
    "Functional Gastrointestinal Disorder",
    "Postviral Gastroparesis",
    "Idiopathic Gastroparesis",
    "Diabetic Gastroparesis",
    "Vagally Mediated Gastroparesis",
    "Postsurgical Gastroparesis",
    "Medication-Induced Gastroparesis",
    "Gastroparesis Diabeticorum",
    "Gastroparesis Cidalis",
    "Gastroparesis Paralyticus",
    "Gastroparesis Vagale"
  ],
  "note": "These are common terms used to describe the condition in clinical practice. The specific term used may vary depending on the context and the healthcare provider."
}
```
...
### 7. llm_request -> granite3.1-dense:8b  cassette `80597f0305854209`
...
### 8. llm_response (openai, 160 tok, 3.227s)
