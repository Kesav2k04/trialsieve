...
| requests resent after the endpoint failed | 0 |
| critic findings | 0 |
...
|---|---|---|---|---|---|---|---|
| vocab_probe | [absent-Metoprolol](vocab_probe/absent-Metoprolol.md) | 2 | 1 | 0 | 0 | 0 | unmappable |
| vocab_probe | [absent-Oral_glucose_tolerance_test](vocab_probe/absent-Oral_glucose_tolerance_test.md) | 2 | 0 | 0 | 0 | 0 | unmappable |
| vocab_probe | [absent-Acute_pancreatitis](vocab_probe/absent-Acute_pancreatitis.md) | 2 | 0 | 0 | 0 | 0 | grounded to 1 code(s) |
| vocab_probe | [absent-Chronic_kidney_disease_stage_3_or_worse](vocab_probe/absent-Chronic_kidney_disease_stage_3_or_worse.md) | 2 | 0 | 0 | 0 | 0 | grounded to 1 code(s) |
| vocab_probe | [absent-Gastroparesis](vocab_probe/absent-Gastroparesis.md) | 2 | 0 | 0 | 0 | 0 | grounded to 1 code(s) |
| vocab_probe | [absent-Type_1_diabetes_mellitus](vocab_probe/absent-Type_1_diabetes_mellitus.md) | 2 | 0 | 0 | 0 | 0 | grounded to 1 code(s) |
| vocab_probe | [broader-Iron_deficiency_anaemia](vocab_probe/broader-Iron_deficiency_anaemia.md) | 2 | 0 | 0 | 0 | 0 | grounded to 1 code(s) |
...
| vocab_probe | [gap-Obesity](vocab_probe/gap-Obesity.md) | 2 | 0 | 0 | 0 | 0 | grounded to 1 code(s) |
| vocab_probe | [gap-Type_2_diabetes_mellitus](vocab_probe/gap-Type_2_diabetes_mellitus.md) | 2 | 0 | 0 | 0 | 0 | grounded to 1 code(s) |
