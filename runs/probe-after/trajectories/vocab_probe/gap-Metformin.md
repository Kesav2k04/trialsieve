...
### 4. llm_response (cassette, 72 tok, 29.614s)
...
```json
{
  ...
  "note": "Includes generic ingredient, hydrochloride salt forms, extended-release formulations, and common trade names."
}
```
```
...
### 7. llm_request -> gemini-3.7-flash-medium  cassette `9a8d22cc45759f43`
...
### 8. llm_response (cassette, 270 tok, 31.818s)
...
```json
{
  ...
  "rejected": [
    {
      "code": "897718",
      "why": "different ingredient (verapamil)"
    },
    {
      "code": "835603",
      "why": "different ingredient (tramadol)"
    },
    {
      "code": "1094107",
      "why": "different ingredient (phenazopyridine)"
    },
    {
      "code": "861467",
      "why": "different ingredient (meperidine)"
    },
    {
      "code": "1049630",
      "why": "different ingredient (diphenhydramine)"
    },
    {
      "code": "1014676",
      "why": "different ingredient (cetirizine)"
    },
    {
      "code": "997488",
      "why": "different ingredient (fexofenadine)"
    },
    {
      "code": "997223",
      "why": "different ingredient (donepezil)"
    },
    {
      "code": "997501",
      "why": "different ingredient (fexofenadine)"
    ...
    {
      "code": "1091392",
      "why": "different ingredient (methylphenidate)"
    }
  ],
  "confidence": "high"
}
