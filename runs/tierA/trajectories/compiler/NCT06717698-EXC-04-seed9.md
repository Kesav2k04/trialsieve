...
### 3. llm_request -> gemini-3.7-flash-medium  cassette `299845ded36a038a`
...
### 4. llm_response (openai, 136 tok, 17.98367667198181s)

```
```json
{
  "checkable": true,
  "reason": "Documented diagnoses of lupus nephritis and ANCA-associated vasculitis are routinely captured as standard diagnostic codes in structured medical records.",
  "concepts": [
    {
...
### 7. llm_request -> gemini-3.7-flash-medium  cassette `8dfd9c6b90c5e142`
...
### 8. llm_response (openai, 160 tok, 16.962134838104248s)
...
```json
{
  ...
  "note": "Includes general diagnostic terms and ISN/RPS histologic classification stages for lupus nephritis."
}
```
```
...
### 11. llm_request -> gemini-3.7-flash-medium  cassette `691f5b9cc225962f`
...
### 12. llm_response (openai, 175 tok, 21.365864038467407s)
...
```json
{
  ...
  "rejected": [
    {
      "code": "45816000",
      "why": "Pyelonephritis is an infectious kidney inflammation, not autoimmune lupus nephritis"
    },
    {
      "code": "422034002",
      "why": "Diabetic retinopathy is a diabetic eye complication, unrelated to lupus nephritis"
    },
    {
      "code": "1551000119108",
...
### 16. llm_request -> gemini-3.7-flash-medium  cassette `7e7f81819cd2f9a3`
...
### 17. llm_response (openai, 139 tok, 17.416242599487305s)
...
```json
{
  ...
  "note": "Includes primary subtypes (GPA, MPA, EGPA), classic eponyms, renal-limited variants, and serotype classifications."
}
```
```
...
### 20. llm_request -> gemini-3.7-flash-medium  cassette `4abf6e5bf26ac90c`
...
### 21. llm_response (openai, 267 tok, 17.84703302383423s)
...
```json
{
  ...
  "rejected": [
    {
      "code": "237602007",
      "why": "metabolic syndrome, unrelated endocrine/metabolic disorder"
    },
    {
      "code": "26929004",
      "why": "Alzheimer's disease, unrelated neurodegenerative disorder"
    },
    {
      "code": "95417003",
      "why": "primary fibromyalgia syndrome, unrelated chronic pain condition"
    },
    {
      "code": "67782005",
      "why": "acute respiratory distress syndrome, unrelated acute pulmonary condition"
    },
    {
      "code": "230265002",
      "why": "familial Alzheimer's disease of early onset, unrelated neurodegenerative disorder"
    },
    {
      "code": "422034002",
      "why": "diabetic retinopathy, unrelated diabetic microvascular complication"
    },
    {
      "code": "423315002",
      "why": "limited social contact, social finding rather than a vasculitis diagnosis"
    },
    {
      "code": "127013003",
      "why": "diabetic renal disease, unrelated diabetic nephropathy"
    }
  ],
  "confidence": "high"
}
