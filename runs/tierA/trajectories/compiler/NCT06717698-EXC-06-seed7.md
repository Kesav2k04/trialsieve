...
{
 "category": "diagnosis",
 "criterion_id": "NCT06717698-EXC-06",
 "kind": "exclusion",
 "source_text": "Only applicable for participants with type 2 diabetes: uncontrolled and potentially unstable diabetic retinopathy or diabetic maculopathy, verified by an eye examination performed within 90 days before screening."
}
```

### 3. llm_request -> gemini-3.7-flash-medium  cassette `2129b02c92990355`
...
### 4. llm_response (openai, 223 tok, 123.29110836982727s)

```
```json
{
  "checkable": false,
  "reason": "Determining whether diabetic retinopathy or maculopathy is 'uncontrolled and potentially unstable' relies on qualitative ophthalmologic examination findings and clinical judgment not captured in structured coded data.",
  "concepts": [
    {
      "name": "Type 2 diabetes mellitus",
      "domain": "condition",
      "intent": "diagnosis of type 2 diabetes mellitus to determine applicability"
    },
    {
      "name": "Diabetic retinopathy",
      "domain": "condition",
      "intent": "diagnosis of diabetic retinopathy"
    },
    {
      "name": "Diabetic maculopathy",
      "domain": "condition",
      "intent": "diagnosis of diabetic maculopathy"
    },
    {
      "name": "Eye examination",
      "domain": "procedure",
      "intent": "ophthalmologic or eye examination procedure within 90 days before index date"
    }
  ]
}
```
...
{
 "compilable": false,
 "reason_not_compilable": "Determining whether diabetic retinopathy or maculopathy is 'uncontrolled and potentially unstable' relies on qualitative ophthalmologic examination findings and clinical judgment not captured in structured coded data."
}
```
