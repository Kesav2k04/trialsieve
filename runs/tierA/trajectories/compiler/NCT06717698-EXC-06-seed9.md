...
### 3. llm_request -> gemini-3.7-flash-medium  cassette `ca406178bf1a29e8`
...
### 4. llm_response (openai, 214 tok, 20.30887269973755s)

```
```json
{
  "checkable": false,
  "reason": "Determining whether diabetic retinopathy or maculopathy is 'uncontrolled and potentially unstable' relies on qualitative eye examination read-outs and clinical judgment that are not captured in structured coded data.",
  "concepts": [
    {
      "name": "type 2 diabetes mellitus",
      "domain": "condition",
      "intent": "presence of diagnosed type 2 diabetes"
    },
    {
      "name": "diabetic retinopathy",
      "domain": "condition",
      "intent": "presence of diabetic retinopathy"
    },
    {
      "name": "diabetic maculopathy",
      "domain": "condition",
      "intent": "presence of diabetic maculopathy"
    },
    {
      "name": "eye examination",
      "domain": "procedure",
      "intent": "ophthalmic examination performed within 90 days prior to the index date"
    }
  ]
}
```
...
{
 "compilable": false,
 "reason_not_compilable": "Determining whether diabetic retinopathy or maculopathy is 'uncontrolled and potentially unstable' relies on qualitative eye examination read-outs and clinical judgment that are not captured in structured coded data."
}
```
