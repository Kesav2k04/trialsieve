...
| Solution video, 5 minutes or less | submitted as a link on the entry form, 4:54. It is a deliverable rather than part of the solution, so it is not a file here and nothing in this repository needs it to run. |
...
| Measured Improvement | 15 | 25 | [docs/SCORECARD.md](docs/SCORECARD.md) for the baseline comparison, [docs/IMPROVEMENT_CHANGELOG.md](docs/IMPROVEMENT_CHANGELOG.md) for 55 entries each tied to the command that shows it. |
