...
| Improvement changelog | [docs/IMPROVEMENT_CHANGELOG.md](docs/IMPROVEMENT_CHANGELOG.md), 55 entries. Its opening table is the whole arc. |
...
- **The Improvement Changelog**, 55 entries, each naming the evidence that found
