...
### 20. llm_request -> gemini-3.7-flash-medium  cassette `ab27c58b25d029bc`
...
### 21. llm_response (cassette, 219 tok, 73.649s)
...
### 24. llm_request -> gemini-3.7-flash-medium  cassette `ad139f0249e836ca`
...
### 25. llm_response (cassette, 211 tok, 83.004s)
...
```json
{
 "error": "AgentError: compile-emit:NCT06989723-EXC-01: no valid reply after 3 attempts. last: AssertionError: criterion.expr.args[1].query: query needs a non-empty list of string codes"
}
```
