...
### 3. llm_request -> gemini-3.7-flash-medium  cassette `047747788dfa9bfb`
...
### 4. llm_response (openai, 107 tok, 38.130067110061646s)

```
```json
{
  "checkable": true,
  "reason": "Diabetic ketoacidosis episodes can be identified from coded condition and encounter records within the 1-month window prior to the index date used as a proxy for the screening visit.",
  "concepts": [
    {
      "name": "Diabetic ketoacidosis",
      "domain": "condition",
      "intent": "diagnosis or encounter for diabetic ketoacidosis within the past 1 month"
    }
  ]
}
```
...
### 7. llm_request -> gemini-3.7-flash-medium  cassette `b1725a5d29d241dd`
...
### 8. llm_response (openai, 176 tok, 34.61210107803345s)
...
```json
{
  ...
  "note": "Includes general, diabetes-type-specific, coma-stratified, and euglycemic presentations of diabetic ketoacidosis."
}
```
```
...
[
 ...
 {
  "code": "431855005",
  "display": "Chronic kidney dise
```

### 11. llm_request -> gemini-3.7-flash-medium  cassette `d80fc58594147262`
...
Concept: Diabetic ketoacidosis
Record domain: condition
Meaning required: diagnosis or encounter for diabetic ketoacidosis within the past 1 month
...
### 12. llm_response (openai, 367 tok, 37.68794131278992s)
...
```json
{
  ...
  "rejected": [
    ...
    {
      "code": "90781000119102",
      "why": "microalbuminuria due to diabetes, not diabetic ketoacidosis"
    },
    {
      "code": "1551000119108",
    ...
    {
      "code": "97331000119101",
      "why": "macular edema and diabetic retinopathy, not diabetic ketoacidosis"
    },
    {
      "code": "422034002",
    ...
    {
      "code": "44054006",
      "why": "unspecified diabetes mellitus; does not represent or specifically denote the acute complication of diabetic ketoacidosis"
    },
    {
      "code": "127013003",
    ...
    {
      "code": "94260004",
      "why": "secondary malignant neoplasm of colon, unrelated"
    },
    {
      "code": "431855005",
      "why": "chronic kidney disease stage 1, unrelated"
    },
    {
      "code": "431856006",
      "why": "chronic kidney disease stage 2, unrelated"
    }
  ],
  "confidence": "high"
}
