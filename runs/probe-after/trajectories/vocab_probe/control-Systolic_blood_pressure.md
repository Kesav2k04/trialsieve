...
### 4. llm_response (cassette, 130 tok, 31.500s)
...
```json
{
  ...
  "note": "Standard clinical observation terms, abbreviations, and positional variants for systolic blood pressure."
}
```
```
...
### 7. llm_request -> gemini-3.7-flash-medium  cassette `e052bfe825b8d115`
...
### 8. llm_response (cassette, 258 tok, 33.536s)
...
```json
{
  ...
  "rejected": [
    ...
    {
      "code": "1960-4",
      "why": "measures arterial bicarbonate, not blood pressure"
    },
    {
      "code": "59408-5",
