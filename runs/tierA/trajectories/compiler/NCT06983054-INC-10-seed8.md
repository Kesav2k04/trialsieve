...
### 3. llm_request -> gemini-3.7-flash-medium  cassette `8f248e2060cf1c54`
...
### 4. llm_response (cassette, 183 tok, 35.480s)

```
```json
{
  "checkable": false,
  "reason": "The requirement for a 'stable dose' lacks a defined time window or operational criteria and requires investigator judgment to evaluate.",
  "concepts": [
    {
      "name": "Metformin",
      "domain": "medication",
      "intent": "currently prescribed diabetes medication"
    },
    {
      "name": "Sulfonylurea",
      "domain": "medication",
...
{
 "compilable": false,
 "reason_not_compilable": "The requirement for a 'stable dose' lacks a defined time window or operational criteria and requires investigator judgment to evaluate."
}
```
