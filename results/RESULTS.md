...
|-----|----------|-------|-------------------------------|--------|-------------|-------------|------------------------|--------|-----------------|
| TS  | 21.8%    | 1.0%  | **2.7666666666666666**        | 4      | 4           | 0           | 18                     | 0      | 40              |
| B0  | 100.0%   | 93.8% | **0.8333333333333334**        | 375    | 375         | 0           | 0                      | 0      | 40              |
| B1  | 7.5%     | 0.0%  | **1.0**                       | 0      | 0           | 0           | 75                     | 0      | 40              |
| B2  | 68.0%    | 43.8% | **3.2333333333333334**        | 175    | 30          | 145         | 6                      | 0      | 40              |

**The co-primary goes to B2.** `docs/EVAL_PROTOCOL.md` registers `resolved_correct_per_screen` as a co-primary outcome, in its own words *so an arm cannot win by abstaining*, and on this group B2 resolves 3.2333333333333334 cells correctly per screen against TrialSieve's 2.7666666666666666. Abstaining costs nothing on silent error rate and it costs exactly this. Both numbers are in the table above rather than in a footnote, because the outcome was registered before the run and the arm it favours does not change that.
...
| arm | coverage | SER   | **resolved correct / screen** | silent | false-FAILS | false-MEETS | unnecessary abstention | errors | unique criteria |
|-----|----------|-------|-------------------------------|--------|-------------|-------------|------------------------|--------|-----------------|
| TS  | 19.1%    | 0.7%  | **2.4571428571428573**        | 111    | 66          | 45          | 618                    | 0      | 40              |
| B0  | 100.0%   | 94.8% | **0.6978354978354978**        | 14594  | 14594       | 0           | 0                      | 0      | 40              |
| B1  | 7.5%     | 0.0%  | **1.0**                       | 0      | 0           | 0           | 2401                   | 0      | 40              |

**The co-primary goes to TS**, 2.4571428571428573 cells resolved correctly per screen against 1.0 for the next arm. It is registered in `docs/EVAL_PROTOCOL.md` so that an arm cannot win by abstaining, so it is printed whichever way it falls.
...
| arm | coverage | SER   | **resolved correct / screen** | silent | false-FAILS | false-MEETS | unnecessary abstention | errors | unique criteria |
|-----|----------|-------|-------------------------------|--------|-------------|-------------|------------------------|--------|-----------------|
| TS  | 19.2%    | 0.7%  | **2.4683982683982686**        | 112    | 67          | 45          | 605                    | 0      | 40              |
| B0  | 100.0%   | 94.8% | **0.6978354978354978**        | 14594  | 14594       | 0           | 0                      | 0      | 40              |
| B1  | 7.5%     | 0.0%  | **1.0**                       | 0      | 0           | 0           | 2401                   | 0      | 40              |

**The co-primary goes to TS**, 2.4683982683982686 cells resolved correctly per screen against 1.0 for the next arm. It is registered in `docs/EVAL_PROTOCOL.md` so that an arm cannot win by abstaining, so it is printed whichever way it falls.
...
| arm | coverage | SER   | **resolved correct / screen** | silent | false-FAILS | false-MEETS | unnecessary abstention | errors | unique criteria |
|-----|----------|-------|-------------------------------|--------|-------------|-------------|------------------------|--------|-----------------|
| TS  | 21.6%    | 0.7%  | **2.7887445887445885**        | 112    | 67          | 45          | 235                    | 0      | 40              |
| B0  | 100.0%   | 94.8% | **0.6978354978354978**        | 14594  | 14594       | 0           | 0                      | 0      | 40              |
| B1  | 7.5%     | 0.0%  | **1.0**                       | 0      | 0           | 0           | 2401                   | 0      | 40              |

**The co-primary goes to TS**, 2.7887445887445885 cells resolved correctly per screen against 1.0 for the next arm. It is registered in `docs/EVAL_PROTOCOL.md` so that an arm cannot win by abstaining, so it is printed whichever way it falls.
...
| arm | coverage | SER   | **resolved correct / screen** | silent | false-FAILS | false-MEETS | unnecessary abstention | errors | unique criteria |
|-----|----------|-------|-------------------------------|--------|-------------|-------------|------------------------|--------|-----------------|
| TS  | 18.8%    | 0.8%  | **2.4077922077922076**        | 116    | 65          | 51          | 635                    | 0      | 40              |
| B0  | 100.0%   | 95.0% | **0.6727272727272727**        | 14623  | 14623       | 0           | 0                      | 0      | 40              |
| B1  | 7.5%     | 0.0%  | **1.0**                       | 0      | 0           | 0           | 2357                   | 0      | 40              |

**The co-primary goes to TS**, 2.4077922077922076 cells resolved correctly per screen against 1.0 for the next arm. It is registered in `docs/EVAL_PROTOCOL.md` so that an arm cannot win by abstaining, so it is printed whichever way it falls.
...
| arm | coverage | SER   | **resolved correct / screen** | silent | false-FAILS | false-MEETS | unnecessary abstention | errors | unique criteria |
|-----|----------|-------|-------------------------------|--------|-------------|-------------|------------------------|--------|-----------------|
| TS  | 18.5%    | 0.7%  | **2.3696969696969696**        | 105    | 60          | 45          | 662                    | 0      | 40              |
| B0  | 100.0%   | 95.0% | **0.670995670995671**         | 14625  | 14625       | 0           | 0                      | 0      | 40              |
| B1  | 7.5%     | 0.0%  | **1.0**                       | 0      | 0           | 0           | 2320                   | 0      | 40              |

**The co-primary goes to TS**, 2.3696969696969696 cells resolved correctly per screen against 1.0 for the next arm. It is registered in `docs/EVAL_PROTOCOL.md` so that an arm cannot win by abstaining, so it is printed whichever way it falls.
...
| arm | coverage | SER   | **resolved correct / screen** | silent | false-FAILS | false-MEETS | unnecessary abstention | errors | unique criteria |
|-----|----------|-------|-------------------------------|--------|-------------|-------------|------------------------|--------|-----------------|
| TS  | 17.5%    | 0.9%  | **2.2147186147186146**        | 135    | 81          | 54          | 706                    | 0      | 40              |
| B0  | 100.0%   | 95.3% | **0.625974025974026**         | 14677  | 14677       | 0           | 0                      | 0      | 40              |
| B1  | 7.5%     | 0.0%  | **1.0**                       | 0      | 0           | 0           | 2183                   | 0      | 40              |

**The co-primary goes to TS**, 2.2147186147186146 cells resolved correctly per screen against 1.0 for the next arm. It is registered in `docs/EVAL_PROTOCOL.md` so that an arm cannot win by abstaining, so it is printed whichever way it falls.
...
| arm | coverage | SER  | **resolved correct / screen** | silent | false-FAILS | false-MEETS | unnecessary abstention | errors | unique criteria |
|-----|----------|------|-------------------------------|--------|-------------|-------------|------------------------|--------|-----------------|
| TS  | 18.4%    | 0.7% | **2.362770562770563**         | 111    | 66          | 45          | 727                    | 0      | 40              |
