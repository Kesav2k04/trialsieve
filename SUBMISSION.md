...
| Solution video, 5 minutes or less | [docs/VIDEO.md](docs/VIDEO.md) for the link, the card table and how it was built. [docs/video/script.md](docs/video/script.md) is what is said, word for word, with every figure resolved. |
...
| Measured Improvement | 15 | 25 | [docs/SCORECARD.md](docs/SCORECARD.md) for the baseline comparison, [docs/IMPROVEMENT_CHANGELOG.md](docs/IMPROVEMENT_CHANGELOG.md) for 53 entries each tied to the command that shows it. |
