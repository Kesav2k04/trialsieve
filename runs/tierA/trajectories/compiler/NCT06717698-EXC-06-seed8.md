...
### 3. llm_request -> gemini-3.7-flash-medium  cassette `72cf63ac20f73541`
...
### 4. llm_response (openai, 223 tok, 27.574287176132202s)

```
```json
{
  "checkable": false,
  "reason": "Determining whether diabetic retinopathy or maculopathy is 'uncontrolled and potentially unstable' requires clinical judgment and detailed ophthalmic examination findings that are not captured in structured coded data.",
  "concepts": [
    {
      "name": "Type 2 diabetes mellitus",
      "domain": "condition",
      "intent": "diagnosis of type 2 diabetes"
    },
    {
    ...
    },
    {
      ...
      "domain": "condition",
      "intent": "diagnosis of diabetic maculopathy or diabetic macular edema"
    },
    {
      "name": "Eye examination",
      "domain": "procedure",
      "intent": "ophthalmologic or retinal examination performed within 90 days before the index date"
    }
  ]
}
```
...
{
 "compilable": false,
 "reason_not_compilable": "Determining whether diabetic retinopathy or maculopathy is 'uncontrolled and potentially unstable' requires clinical judgment and detailed ophthalmic examination findings that are not captured in structured coded data."
}
```
