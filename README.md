...
| Improvement changelog | [docs/IMPROVEMENT_CHANGELOG.md](docs/IMPROVEMENT_CHANGELOG.md), 71 entries. Its opening table is the whole arc. |
...
- **The Improvement Changelog**, 71 entries, each naming the evidence that found
