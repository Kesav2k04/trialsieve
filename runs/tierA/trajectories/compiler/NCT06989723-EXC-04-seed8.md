...
### 3. llm_request -> gemini-3.7-flash-medium  cassette `02244c6f35d434b4`
...
### 4. llm_response (cassette, 168 tok, 31.792s)
  ...
  "concepts": [
    {
      ...
      "domain": "condition",
      "intent": "documented diagnosis of hepatocellular carcinoma"
    },
    {
      "name": "malignancy",
      "domain": "condition",
      "intent": "documented diagnosis of active malignant neoplasm"
    },
    {
      "name": "metastatic cancer",
      "domain": "condition",
      "intent": "documented diagnosis of secondary or metastatic malignant neoplasm"
    }
  ]
}
```
...
### 7. llm_request -> gemini-3.7-flash-medium  cassette `003466900ea32420`
...
### 8. llm_response (cassette, 144 tok, 32.837s)
...
```json
{
  "names": [
    ...
    "Hepatoma",
    "Primary malignant neoplasm of liver cells",
  ...
  "note": "Includes primary liver cell carcinoma diagnostic terms and recognized histological subtypes coded in clinical records."
}
```
```
...
### 11. llm_request -> gemini-3.7-flash-medium  cassette `c916f7e1b99cf378`
...
Concept: hepatocellular carcinoma
Record domain: condition
Meaning required: documented diagnosis of hepatocellular carcinoma
...
### 12. llm_response (cassette, 362 tok, 31.527s)
...
```json
{
  ...
  "rejected": [
    {
      "code": "92691004",
      "why": "carcinoma in situ of prostate; different anatomical site"
    },
    {
      "code": "254837009",
    ...
    {
      "code": "424132000",
      "why": "non-small cell carcinoma of lung; different anatomical site"
    },
    {
      "code": "109838007",
    ...
    {
      "code": "126906006",
      "why": "neoplasm of prostate; different anatomical site"
    },
    {
      "code": "254637007",
    ...
    {
      "code": "363406005",
      "why": "malignant tumor of colon; different anatomical site"
    },
    {
      "code": "95417003",
      "why": "primary fibromyalgia syndrome; unrelated non-neoplastic disorder"
    },
    {
      "code": "201834006",
      "why": "primary osteoarthritis of the hand; unrelated musculoskeletal disorder"
    },
    {
      "code": "224295006",
      "why": "educational attainment finding; not a medical condition"
    },
    {
      "code": "314994000",
      "why": "metastasis from prostate cancer; different primary site"
    }
  ],
  "confidence": "high"
}
...
### 16. llm_request -> gemini-3.7-flash-medium  cassette `7ec327900059e78a`
...
### 17. llm_response (cassette, 100 tok, 30.661s)
...
```json
{
  ...
  "note": "Includes overarching diagnostic categories and major histological subtypes of malignant neoplasms."
}
```
```
...
### 20. llm_request -> gemini-3.7-flash-medium  cassette `484856e8bdb46d7a`
...
Concept: malignancy
Record domain: condition
Meaning required: documented diagnosis of active malignant neoplasm
...
### 21. llm_response (cassette, 124 tok, 37.498s)
...
```json
{
  ...
  "rejected": [
    {
      "code": "92691004",
      "why": "carcinoma in situ is a pre-invasive lesion, not a diagnosis of invasive malignant neoplasm"
    },
    {
      "code": "162573006",
      "why": "suspected condition, not a confirmed documented diagnosis"
    }
  ],
  "confidence": "high"
}
...
```json
{
 "concept": "metastatic cancer",
 "domain": "condition",
 "intent": "documented diagnosis of secondary or metastatic malignant neoplasm"
}
```

### 25. llm_request -> gemini-3.7-flash-medium  cassette `6126bc7c92b25dcc`
...
### 26. llm_response (cassette, 176 tok, 31.154s)
...
```json
{
  ...
  "note": "Includes general secondary neoplasm codes and common site-specific metastatic diagnosis terms."
}
```
```
...
### 29. llm_request -> gemini-3.7-flash-medium  cassette `219bae04e16f7b4f`
...
Concept: metastatic cancer
Record domain: condition
Meaning required: documented diagnosis of secondary or metastatic malignant neoplasm
...
### 30. llm_response (cassette, 373 tok, 32.385s)
...
```json
{
  ...
  "rejected": [
    {
      "code": "254837009",
      "why": "represents primary/unspecified malignant neoplasm of breast, not secondary or metastatic cancer"
    },
    {
      "code": "109838007",
      "why": "represents overlapping lesion/primary malignant neoplasm of colon, not metastatic cancer"
    },
    {
      "code": "92691004",
      "why": "represents carcinoma in situ (non-invasive), not metastatic cancer"
    },
    {
      "code": "424132000",
      "why": "represents stage 1 (early/localized) carcinoma of lung, not metastatic cancer"
    },
    {
      "code": "126906006",
      "why": "represents neoplasm of prostate (unspecified behavior/primary), not secondary/metastatic cancer"
    },
    {
      "code": "363406005",
      "why": "represents primary/unspecified malignant tumor of colon, not secondary or metastatic cancer"
    },
    {
      "code": "110030002",
      "why": "represents traumatic brain injury, unrelated to cancer"
    },
    {
      "code": "162573006",
      "why": "represents suspected condition/situation, not a documented diagnosis of metastatic cancer"
    },
    {
      "code": "275272006",
      "why": "represents traumatic brain damage, unrelated to cancer"
    },
    {
      "code": "254637007",
      "why": "represents primary/unspecified non-small cell lung cancer, not secondary or metastatic cancer"
    }
  ],
  "confidence": "high"
}
