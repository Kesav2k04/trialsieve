...
### 3. llm_request -> gemini-3.7-flash-medium  cassette `c26bf1809d45b224`
...
### 4. llm_response (openai, 130 tok, 17.607771158218384s)

```
```json
{
  "checkable": false,
  "reason": "The criterion is not checkable because it requires investigator judgement to decide whether medication changes affect study outcomes.",
  "concepts": [
    {
      "name": "anti-diabetic medication",
      "domain": "medication",
      "intent": "prescription or dosage changes within the past 3 months"
    },
    {
...
{
 "compilable": false,
 "reason_not_compilable": "The criterion is not checkable because it requires investigator judgement to decide whether medication changes affect study outcomes."
}
```
