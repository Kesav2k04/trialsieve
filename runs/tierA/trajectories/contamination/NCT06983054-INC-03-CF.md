...
```json
{
 ...
 "criterion_id": "NCT06983054-INC-03-CF",
 "kind": "inclusion",
 "source_text": "Age 18 - 116.5 years of age"
}
```

### 3. llm_request -> gemini-3.7-flash-medium  cassette `a3d87c8ce19b9b21`
...
### 4. llm_response (cassette, 47 tok, 128.828s)

```
```json
{
  "checkable": true,
  "reason": "Age can be directly calculated from the participant's date of birth in demographic records relative to the index date.",
  "concepts": []
}
```
```

### 5. llm_request -> gemini-3.7-flash-medium  cassette `f306eb2c0e2e9c36`
...
### 6. llm_response (cassette, 78 tok, 60.608s)
...
```json
{
  ...
  "unit_note": "years of age",
  "absence_note": "No queries involved; demographic age is evaluated directly.",
  "confidence": "high"
}
```
```
